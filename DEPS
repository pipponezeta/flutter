...
vars = {
  ...
  'dart_revision': '6cece361df651042b095528706d41e615b9bf4c1',
  ...
  'dart_ecosystem_rev': '5b8e6b8973663a64be5b98159da51409267a685b',
  'dart_http_rev': '9129a96be871a5779436f042bd13790960171373',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@0cd2e55256cecb2a9806b6fa6930c9af7d0394e1',
     ...
     'packages': [
       {
        ...
        'version': 'y-WmESARBN4BZF0gs01qw_Obo6M122QZemPcqaKFWYYC'
       }
     ],
